# Notes from Kent C. Dodds Epic React workshop

## Reference:
### Testing:
- [General Testing Principles](NOTES/Testing/General.md)
- [Basic Testing/Unit Testing](NOTES/Testing/Testing.md)
- [Integration Testing](NOTES/Testing/IntegrationTests.md)
